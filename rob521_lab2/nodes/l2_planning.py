...
class PathPlanner:
    ...
    def __init__(self, map_filename, map_setings_filename, goal_point, stopping_dist):
        ...
        self.window.add_line(np.array([-4, -48]), np.array([47, -48]), width=2, color=(0, 255, 255))
        self.window.add_line(np.array([47, -48]), np.array([47, 11]), width=2, color=(0, 255, 255))
        self.window.add_line(np.array([47, 11]), np.array([-4, 11]), width=2, color=(0, 255, 255))
        self.window.add_line(np.array([-4, 11]), np.array([-4, -48]), width=2, color=(0, 255, 255))
    ...
    def sample_map_space(self):
        ...
        # Default uniform sampling or other strategies
        x = np.random.uniform(-2, 45)
        y = np.random.uniform(-48, 10)
